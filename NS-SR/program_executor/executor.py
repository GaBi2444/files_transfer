...
class Executor():
    ...
    def __init__(self,situations, label_dir='/Users/yushoubin/Desktop/Data_release/v1.1.6/classes/'):
    ...
    def Situations(self):
        ...
        for frame in self.situations:
            ...
            try:
                ...
                bbox_labels = []
                for rel_pairs in self.situations[frame]['rel_pairs']:
                    bbox_labels.extend(rel_pairs)
                situations[frame]['bbox_labels'] = list(set(bbox_labels))
...
#-------------ELEMENT MODULE--------------
    ...
    def Objs(self,situations):
        ...
        for frame in sort_frame:
            ...
            exist_objs = [obj for obj in exist_objs if obj!='<unk>']
    ...
    def Rels(self,situations):
        ...
        for frame in sort_frame:
            ...
            exist_rels = [rel for rel in exist_rels if rel!='<unk>']
