...
class TrainOptions(BaseOptions):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--max_val_samples', default=None, type=int, help='max number of val samples')
        # Model
        ...
        self.parser.add_argument('--visualize_training', default=1, type=int, help='visualize training with tensorboard')
