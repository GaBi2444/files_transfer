...
class TestOptions(BaseOptions):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--split', default='test', type=str, help='dataset split')
        self.parser.add_argument('--max_train_samples', default=None, type=int, help='max train data')
