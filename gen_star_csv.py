...
if __name__ == '__main__':
    ...
    parser.add_argument("--max_frame_json", default='/nobackup/users/bowu/data/Charades_v1_480/charades_max_frame_ids.json', type=bool)
    ...
    print("cls map ready")
    max_frame_dict = json.load(open('/gpfs/u/home/NSVR/NSVRbowu/scratch/data/ActionGenome/tools/max_frame_ag.json', 'r'))
    star2charades = {}
